...
public class DB extends SQLiteOpenHelper {
    private static final String dbname="fatima";
    private static final int v=1;
    private static final String SQLdb = "CREATE TABLE giselle (id text, rev text, idProductos text, codigo text, " +
    ...
    public String administrar_prod(String accion, String[] datos){
        try {
            ...
            if (accion.equals("nuevo")) {
                sql = "INSERT INTO giselle (id,rev,idProductos,codigo,descripcion,marca,presentacion,precio, foto) VALUES('"+ datos[0] +"','" + datos[1] +
                        "','" + datos[2] + "','" + datos[3] + "','" + datos[4] + "','" + datos[5] + "', '"+ datos[6] +"', '"+ datos[7] +"', '"+ datos[8] +"')";
            } else if (accion.equals("modificar")) {
                sql = "UPDATE giselle SET id='" + datos[0] + "', rev='" + datos[1] + "', codigo='" + datos[3] + "',descripcion='" + datos[4] + "',marca='" +
                        datos[5] + "',presentacion='" + datos[6] + "',precio='" + datos[7] + "', foto='"+ datos[8] +"' WHERE idProd='" + datos[2] + "'";
            } else if (accion.equals("eliminar")) {
                sql = "DELETE FROM giselle WHERE idProd='" + datos[2] + "'";
            }
            db.execSQL(sql);
            return "ok";
        }catch (Exception e){
